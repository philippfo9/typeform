...
function generateFormComponent(filePath, className) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (fs.existsSync(filePath + ".ts")) {
            ...
            let ngFor = "", formArrayDiv = "", editBtn = "", deleteBtn = "", actionBtns = "", addFunc = "", removeFunc = "", updateFunc = "", enableChangeFunc = "", cancelChangeFunc = "", propertyDefinitionType = "", propertyDefintionName = "", formGroup = "";
            if (listActivated) {
